...
import FoodData1 from './FoodData1';
import Set from './Set'
...
const [fdata1,setFdata1]=useState(FoodData1)
// console.log(fdata)

const [copyData1,setcopyData1]=useState([]);
...
if(getChangData ==""){
    ...
    let StorData = copyData1.filter((ele,k)=>{
        return ele.rname.toLowerCase().match(getChangData);
    });

     setcopyData1(StorData);
}
...
return (
        <>
            ...
            <section className='iteam-section mt-4 container'>
                ...
                {/* for skeliton */}
                { copyData1 && copyData1.length ? <Cards data={copyData1} />:<Set sdata={fdata1}/>}
                </div>
            </section>
